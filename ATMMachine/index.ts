...
// when account information is selected.
    if (options.option === "Account Information"){
        // make a interface , how thw info should look like.
        interface PersonInfo {
            [key: string]: any;
        }
        
        // making a function that print person's account information.
        function storeAndPrintPersonInfo(personInfo: PersonInfo): void {
...
// conditional statements for the choices of fast cash.
        if (fastCashWithdraw.cash === 5000){
            ...
            else {console.log(chalk.red(`You don't have enough balance.`))}
        }
...
// defining how the trasaction will look like by using interface.
        interface transactionHistory {
            [key: string]: any;
        }
// making a function that store the transaction history using the transactionHistory interface and then print the info.
        function storeAndPrintTransactionHistory(transactionHistory: transactionHistory){
